...
// 3 hours + slight initial schedule delay not to conflict with shorter period stats (1 minute)
const DEFAULT_STATS_VIEWS_CALCULATE_LONGER_PERIODS_SCHEDULE_DELAY = MINUTE_MILLIS;
const DEFAULT_STATS_VIEWS_CALCULATE_LONGER_PERIODS_INTERVAL = 3 * 60 * MINUTE_MILLIS;
// 6 hours + slight initial schedule delay not to conflict with longer period stats (5 minutes)
