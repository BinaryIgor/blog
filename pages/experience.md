...
<p id="modivo-gallery-link" class="gallery-link">This is how it looked.</p>
...
<p id="collybri-gallery-link" class="gallery-link">This is how it looked.</p>
...
<p id="hairo-gallery-link" class="gallery-link">This is how it looked.</p>
...
In a random order:
* <span id="linkuro-gallery-link" class="gallery-link">Linkuro</span> - it was a slight variation of [Collybri](#co-founder-at-collybri) that we launched again with my brother; unfortunately, we did not find an effective-enough way of promoting it
